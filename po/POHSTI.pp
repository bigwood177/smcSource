...
;
;		OPEN PURCHASE ORDER REPORT BY PART NUMBER
;
;
;
;
...
RECORD
	...
	SRCCTL	,D1
	SWITCH	,D1
	TITLE	,A34,	'OPEN PURCHASE ORDER REPORT BY PART'
	TODAY	,D6
	V	,D1
	WTARG	,D1,	2
	XRECNO	,D5
...
PROC
	...
	XCALL TNMBR(TNUM)
	TEXT=TNUM,'XXX'
	XCALL OUTPT (2,1,2,'OPEN P.O. REPORT BY ITEM',1)
GETDAT,
...
OPNFIL,
	...
	XCALL WATE (4,V)
	XCALL OUTPT (2,1,0,'OPEN P.O. REPORT BY ITEM',1)
