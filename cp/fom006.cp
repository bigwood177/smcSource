...
RECORD	FILLOC
		,A*,	'\\server-dc01\home\Material Data\Pricing\Flat Oval Mapping\Connectors.txt'
...
RECORD	VARS
	KEYCOD	,A5
	KC_4	,A5	;KEY CODE 45 DEG CONNECTORS
	KC_9	,A5	;KEY CODE 90 DEG CONNECTORS
	SAVR	,A15
	SAVE	,A15
	CHN182	,D2
	OPNOK	,D1
...
PROC
	XCALL TERID (V)
	XCALL OUTPT (1,1,2,'FLAT OVAL TABLES - CONNECTORS',1)
...
PDISP,
	CNGCTL = 
	XCALL OUTPT (1,1,2,'PRINT FLAT OVAL CONNECTORS TABLE',1)
