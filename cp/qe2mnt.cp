...
RECORD	PRINT
	TITLE	,A*,	'MATERIAL SPECIFIC CODES'
	HD	,A6,	'NO HDR'
	LG	,A9,	'NO LEGEND'
	PLINE	,A80
	PRNTON	,D1
...
PROC
	XCALL TERID (V)
	XCALL OUTPT (1,1,2,'MATERIAL SPECIFIC CODES',1)
...
DISPLA,
	CLEAR CNGCTL
	XCALL OUTPT (2,1,2,'*** USE (CTRL +V) TWICE TO PASTE PD-ID STRING ***',1)
	XCALL OUTPT ( 4,4,0,'1. PD-ID',1)
	XCALL OUTPT ( 6,4,0,'2. F1-NOTE',1)
	XCALL OUTPT ( 8,4,0,'3. ITEM',1)
...
DSPREC,	;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	XCALL OUTPT (4,24,1,MC_PID,1)
	ENTRY(1,2) = MC_F1, 'XX'
	XCALL OUTPT (6,24,1,ENTRY(1,2),1)
	XCALL OUTPT (8,24,1,MC_ITEM,1)
...
PDISP,
	CNGCTL = 
	XCALL OUTPT (1,1,2,'PRINT MATERIAL SPECIFIC CODES',1)
...
PLOOP,
	...
	IF (TB2COD .NE. 'MC') GOTO EOF


	PLINE (1,36) = MC_PID
	PLINE (38,39) = MC_F1, 'XX'
	PLINE (43,57) = MC_ITEM
;  ID                                   F2 ITEM
;  AAAAAAAA-AAAA-AAAA-AAAA-AAAAAAAAAAAA XX AAAAAAAAAAAAAAA
