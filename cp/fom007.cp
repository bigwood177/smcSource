...
RECORD	FILLOC
		,A*,	'\\server-dc01\home\Material Data\Pricing\Flat Oval Mapping\Hangers.txt'
...
RECORD	VARS
	KEYCOD	,A5
	KC_4	,A5	;KEY CODE 45 DEG HANGERS
	KC_9	,A5	;KEY CODE 90 DEG HANGERS
	SAVR	,A15
	SAVE	,A15
	CHN182	,D2
	OPNOK	,D1
...
PROC
	XCALL TERID (V)
	XCALL OUTPT (1,1,2,'FLAT OVAL TABLES - HANGERS',1)
...
PROCES,
	...
	XCALL OUTPT(11,20,1,FO_REF,1)
	XCALL MESAG ('HANGER DATA',1)
	GOTO DISPLA	
...
PDISP,
	CNGCTL = 
	XCALL OUTPT (1,1,2,'PRINT FLAT OVAL HANGERS TABLE',1)
...
U_LOOP,
	...
	FOR I FROM 1 THRU 10				;DATA IN FIRST 9 COLUMNS
		BEGIN
