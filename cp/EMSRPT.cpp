...
;;;	XCALL LPOFF (LPSW,SPLFIL,PGCNT)
	...
	xcall sndem(stman)	;active-x to e-mail report
...
;;;	XCALL LPON (LPSW,SPLFIL)
	...
	USING STMAN SELECT
	(01),	OPEN(16,O,'SPL:LEON.RTF')
	(03),	OPEN(16,O,'SPL:LOU.RTF')
	(04),	OPEN(16,O,'SPL:DON.RTF')
	(),	BEGIN
		XCALL MESAG('SALESMAN MUST BE 1, 3 OR 4',1)
		GOTO PRINT_REPORT
		END
	ENDUSING

;;;	OPEN(16,O,'SPL:CATRPT.RTF')
	XCALL RTF(16,START_RTF)
	WRITES(16,TITLE)
...
;;;	IF (SWITCH .EQ. 9) RETURN
	open(4,si,'smc:slhh02.smm')
	CHN184 = 4

;;;	XCALL FILES (5, 'SI', 185, SWITCH)	;SLHLIN
;;;	IF (SWITCH .EQ. 9) RETURN
	open(5,si,'smc:slhl02.smm')
	CHN185  = 5
