...
record
		...
		,a7,	'     72'
record	,X
	row_head,14a7	;array of row headers
...
record	vars
	...
	cmpcod	,a3
	chnprc	,d2
	LL	,d3			;enlarged screen - last row
	entry	,a30
	inxctl	,d1
...
;;;	xcall wancn (w_id, ll, cngctl, whatno)
	call wancn	;need 3 digit whatno
...
dis_scr,	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
		...
		xcall xyb (1,1,'2" SLB/SLF PRICING',w_id, 0)
...
dis_el,	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	call mak_idx
	a3 = sm_price(idx), 'ZZX'
	xcall xyb (c_row, c_col, a3, w_id, 1)
	return
;----------------------------------------------------------
...
WHTNUM,
	...
	XCALL WINPT (W_ID,LL,20,3,0,'# ',a3,INXCTL)    ; GET # OF FIELD
	GO TO (WHTNUM), INXCTL
