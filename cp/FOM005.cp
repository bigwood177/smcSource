...
RECORD	FILLOC
		,A*,	'\\server-dc01\home\Material Data\Pricing\Flat Oval Mapping\Elbows.txt'
...
RECORD	PRINT
	TITLE	,A*,	'FLAT OVAL - ELBOWS & ANGLES'
	HD	,A6,	'NO HDR'
	LG	,A9,	'NO LEGEND'
	PLINE	,A132
	PRNTON	,D1
...
RECORD	VARS
	KEYCOD	,A5
	KC_4	,A5	;KEY CODE 45 DEG ELBOWS & ANGLES
	KC_9	,A5	;KEY CODE 90 DEG ELBOWS & ANGLES
	SAVR	,A15
	SAVE	,A15
	CHN182	,D2
	OPNOK	,D1
...
PROC
	XCALL TERID (V)
	XCALL OUTPT (1,1,2,'FLAT OVAL TABLES - ELBOWS & ANGLES',1)
...
PROCES,
	...
	XCALL MESAG ('ELBOWS/ANGLES DATA',1)
	GOTO DISPLA	
...
PDISP,
	CNGCTL = 
	XCALL OUTPT (1,1,2,'PRINT FLAT OVAL ELBOWS & ANGLES TABLE',1)
...
UPD_TABLE,	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	CLEAR COPTBL
	TBLCOD = 'FO'
	USING REFO_CODE(5,5) SELECT
	('4'),	KEYCOD = KC_4	;45 DEG
	('9'),	KEYCOD = KC_9	;90 DEG
	ENDUSING
