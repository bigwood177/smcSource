...
RECORD	FILLOC
		,A*,	'\\server-dc01\home\Material Data\Pricing\Flat Oval Mapping\ENDCAPS.txt'
...
PROC
	XCALL TERID (V)
	XCALL OUTPT (1,1,2,'FLAT OVAL TABLES - END CAPS',1)
	
	CALL OPENS
	IF (.NOT. OPNOK) GOTO ENDOFF

	KEYCOD = 'FOEC'		;END CAPS
MENU,
	CALL CHECK_HEADER
	XCALL OUTPT (1,1,2,'FLAT OVAL TABLES - END CAPS',1)
...
DISPLA,
	...
	XCALL OUTPT (9,4,0,'6. END CAP',1)
	XCALL OUTPT(10,4,0,'7. REF',1) 
...
U_LOOP,
	...
	FOR I FROM 1 THRU 10				;DATA IN FIRST 10 COLUMNS
		BEGIN
		...
		(9),	BEGIN
			...
			END
		(10),	BEGIN
			IF (T2.LE.T1) T2 = LN		;IN CASE NO TRAILING TAB
			ADESCR = DATA(T1,T2-1)
			END
